...
BTN_REFERRALS_SHORT = "👥 Рефералы"
BTN_LINK_EMAIL = "✉️ Привязать почту"
BTN_CHANGE_EMAIL = "🔄 Сменить почту"
BTN_UNLINK_EMAIL = "❌ Отвязать почту"
BTN_PURCHASE_PROMO = "🎟 Применить промокод"
BTN_PURCHASE_PLANS = "📦 Выбрать тариф"
BTN_EXIT = "🚪 Выход"
