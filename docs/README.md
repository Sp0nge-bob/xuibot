...
| [Redis — план миграции](redis-migration-plan.md) | Поэтапный перенос FSM и сессий на Redis |
| [PostgreSQL — план миграции](postgresql-migration-plan.md) | Опциональный переход бота с SQLite на PostgreSQL |
